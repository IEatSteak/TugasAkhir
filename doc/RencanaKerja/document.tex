...
\begin{document}
	...
	Salah satu bidang yang terdampak besar dari perubahan ini merupakan bidang olahraga.
	Sekarang berbagai organisasi-organisasi dari berbagai cabang olahraga di dunia sudah mulai untuk mengambil data seperti contohnya olahraga baseball dimana organisasi dengan nama MLB mengambil data lintasan dari bola yang dilempar untuk mendapatkan berbagai informasi seperti kecepatan, putaran, dan lain-lain.
	...
	Ataupun sebuah studi yang dilakukan dari Departemen Transportasi Maryland dengan judul Applications of Trajectory Data From the Perspective of a Road Transportation Agency: Literature Review and Maryland Case Study oleh Nikola Markovic yang menganalisis jutaan titik lintasan GPS untuk meningkatkan keefektifan rute yang diambil bus.
